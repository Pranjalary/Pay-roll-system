...
<table>
<tr>
<td align="right"><div align="center">Grade Code</div></td><td><input type="text" name="gcode"></td>
</tr>
<tr>
<td><div align="center">Grade Description</div></td><td><input type="textfield" name="gdesc"></td>
</tr>
<tr>
<td><div align="center">Starting Basic</div></td><td><input type="text" name="sbasic"></td>
</tr>
<tr>
<td><div align="center">Ending Basic</div></td><td><input type="text" name="ebasic"></td>
</tr>
<tr>
...
<tr>
<td><div align="center">Con Per</div></td><td><input type="text" name="con"></td>
</tr>
</table>
<pre>
<table>
...
<input type="submit" value="DELETE" style="width:80;height:20; border:1px solid #0000FF" onClick="delgrd()">
