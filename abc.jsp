...
<tr>
<td>Employee Code</td><td><input type="text" name="empid"></td>
<td></td>
...
<input type="submit" value="EDIT" style="width: 80; height:20; border: 1px solid #0000FF">
<input type="submit" value="DELETE" style="width:80;height:20; border:1px solid #0000FF">
<input type="submit" value="SEARCH" style="width:80;height:20; border:1px solid #0000FF">
<input type="submit" value="ADDNEW" style="width:80;height:20; border:1px solid #0000FF">
